...
def main():
    ...
    libtcod.console_init_root(screen_width, screen_height, "EPQ Project", False)
    ...
    while not libtcod.console_is_window_closed():
        ...
        if inventory_index is not None and previous_game_state!=GameStates.PLAYER_DEAD and inventory_index<len(player.inventory.items):
            ...
            elif game_sates==GameStates.DROP_INVENTORY:
        ...
        if game_state==GameStates.TARGETING:
            if left_click:
                ...
                item_use_results=player.inventory.use(targetingdict_items,entitiesfov_map=fov_map,
        ...
        for player_turn_result in player_turn_results:
            ...
            if targeting_cancelled:
                ...
                message_log.add_message(Message("Targeting cencelled"))
