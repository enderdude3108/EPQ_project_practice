...
def cast_lightning(*args,**kwargs):
    ...
    if target:
        results.append({"consumed":True,"target":target,"message":Message("A lightenening bolt strikes the {0} with a loud thunder! The damage is {1}".format(target.name,damage))})
